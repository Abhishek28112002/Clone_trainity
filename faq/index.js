...
[
  { question:"Q. Do I need to have a laptop or desktop to do the specialization or can I do it on mobile too?"
...
[
  ...
  answer: "You could try making the payment from a different card or account (of a friend or family). Otherwise, you can follow the instructions on how to make an offline payment here.",}
    { question: " Q. What are the different options available to pay the program fee?",
    answer: "You can pay the specialization fee online using any of the following payment methods - debit card, credit card, netbanking, UPI, and wallets. You will receive the link to make the payment once your application is successful.",}
    { question: "Q. My payment got deducted twice. What should I do now?",
    answer: "Just let us know your registered email id along with the screenshot of the payment receipt or transaction history. You can submit your request using the using the "Need further assistance?" section. Once verified, the additional amount you paid will be refunded."}
    { question: "Q. I can not pay the entire fee in one go and would like to pay it in installments. What should I do?",
    answer:"Depending on your payment method, you can opt for no cost EMI where a certain amount will be deducted from your account every month over a period of EMI duration that you choose. Please note that the no-cost EMI is available only select payment methods that you can see here."}
   { question: "Q. The payment shows failed but money got deducted? What should I do now?",
   answer: "The amount deducted will come back to your account within 7-10 working days. This is the normal duration your bank will take to credit the amount back into your account."},
    { question: "Q. How does the EMI option work? How much amount will I need to pay every month? Do I need to pay extra as interest cost?",
    answer:"If you choose to pay via EMI, a certain amount will be deducted from your account every month. For example, if the total program fee (including taxes) is Rs. 100 and you choose to pay via 12 months EMI then you will be charged Rs. 8.33 (100/12) every month. Since these are no cost EMIs, you don't need to pay anything extra as interest or processing fee. The total program fee you would pay over the duration of the EMI will remain the same as it would have been if you paid all of it upfront."},
   { question:"Q. The payment was successful but it still shows 'Make Payment' on my dashboard? What should I do?",
   answer:"At times, there may be a slight delay in your payment reflecting on your Internshala Trainings dashboard. However, if your payment is not reflecting even after 30 minutes, please let us know your registered email id along with the screenshot of the payment receipt or transaction history. You can submit your request using the using the "Need further assistance?" section. Once verified, we will update your payment status from the backend."},
   { question: "Q. Can I stop or cancel the EMIs later if I decide not to continue with the specialization?",
   answer: "No, you can not cancel or stop the EMIs at a later date since your bank would have already paid the entire program fee on your behalf to Internshala"},
    { question: "Q. I faced a problem while making the payment, what should I do?",
    answer: "Please write to us on jos@internshala.com with details and we would be happy to help."},
    { question: "Q. Can I get a refund from the program?",
    answer: "Once the user has made the payment and accessed the training content, no refund would be permitted if the user does not graduate from the program. For the process for a student to claim a refund under the internship guarantee and stipend guarantee, please refer to Guaranteed Internship Program in FAQ."},
],
[
...
[
  { question: "Q. What certificate will I receive from Internshala upon completing the specialization?",
  answer: "Upon successful completion of the specialization, you will receive a Full-Stack Development Specialization certificate from Internshala Trainings."},
{ question: "Q. What is the criteria for one to receive the specialization certificate upon completion?",
answer: "The necessary requirements to be eligible for the specialization certificate are as follows -"
 `<p>1. Min. 75% aggregate marks</P>
 <p>2. Submission of the mandatory projects</p>
 <p>3. Attending the viva and career planning session</p>` },
]
[
  { question: "Q. Who will be the mentor for my career planning session and how would this session help me in my career?",
  answer: "The Career Planning Session will take place along with the viva and your mentor for these sessions would be an expert with 5+ years of experience in the industry. This session will be an opportunity for you to discuss your career goals and get personalised feedback and guidance from the mentor."},
{ question: "Q. What kind of internship can I expect upon completion of the program and where?",
answer: "For graduating specialization students, we will curate Full-Stack Development internships with stipends. These internships come from the pool of recruiters who use Internshala for hiring and can be anywhere in India (including work from home) and you can apply to them as per your choice."},
{ question: "Q. What is the internship guarantee?",
answer: "Internshala guarantees that every eligible specialization student will be able to secure an internship (or a full-time employment) within 12 months from the start of the specialization program (Internship Guarantee Period); failing which Internshala will refund the specialization fee paid by the student."},
{ question: "Q. What internship will be considered towards this guarantee?",
answer: "Any internship or full-time employment that a student gets, in a profile directly related to the specialization program or otherwise, through their own efforts, via Internshala, or any other medium, will be considered."},
{ question: "Q. What is the process for a student to claim a refund under the internship guarantee?",
answer: "If you satisfy the eligibility criteria and still fail to get any internship (or full time employment) with-in Internship Guarantee Period, please write to jos@internshala.com upon completion of the Internship Guarantee Period. We will let you know of the documents required to process your claim."},
{ question: "Q. What is the process for a student to claim a refund under the stipend guarantee?",
answer: "If you satisfy the eligibility criteria and get an internship whose stipend/salary does not match the guaranteed stipend, please write to us on jos@internshala.com with details and documents (like offer letter or appointment letter) upon completion of your internship/full time employment. We will let you know of the remaining documents required to process your claim."},
{ question: "Q. How would the internship placement process work?",
answer: "After graduating from the specialization, on regular intervals, Internshala will share with you relevant full-stack development internships that you can apply to as per your choice. As a specialization student, your application will be highlighted to the recruiters. Companies will shortlist and assess you as per their respective policies."},
{ question: "Q. What are placement preparation sessions?",
answer: "Placement preparation sessions are 1:1 sessions for specialization students so as to prepare them for interviews. These include sessions on cover letter writing, resume writing, LinkedIn profile building, and mock interviews.These are mandatory sessions and in case the user isn't attending any session, they will be debarred from the guaranteed internship program. The user will still be able to access the learning content."}
]
];
